<form method="POST" action="/event/{{$event->id}}">
    @csrf
    @method("PATCH")
    Titulo catalan: <input type="text" name="title_catalan" value="{{$event->title_catalan}}"><br>
    Titulo castellano: <input type="text" name="title_spanish" value="{{$event->title_spanish}}"><br>

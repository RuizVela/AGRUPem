...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <section class="card">
                <h3 id="resource_link" href="<?php echo e($novelty->url); ?>"><?php echo e($novelty->getLocalTitle()); ?></h3>
                <p id="resource_link" href="<?php echo e($novelty->url); ?>"><?php echo Str::words($novelty->getLocalContent(), 20,"..."); ?></p>

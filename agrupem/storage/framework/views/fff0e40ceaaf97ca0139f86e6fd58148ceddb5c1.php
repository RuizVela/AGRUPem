...
<body>
    ...
    <nav class="navbar navbar-light navbar-expand-md shadow p-3 mb-5">
            ...
            <img id="logotipo" src="<?php echo e(asset('/images/logoletrasnegras.png')); ?>" alt="logotipo de agrupem">
            </a>
        ...
        <div class="collapse navbar-collapse flex-wrap" id="navbarTogglerDemo01">
            ...
            <div class="navbar-nav ml-auto align-content-centre col-md-12 justify-content-end">
                ...
                <?php $locale = session()->get('locale'); ?>
                    ...
                    <div class="">
                        <a id="nav-button" class="nav-link nav-item " href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right " aria-labelledby="navbarDropdown">
                            ...
                            <a id="nav-button" class="nav-link nav-item " href="<?php echo e(route('register')); ?>"><?php echo e(__('Registrar')); ?></a>
                    ...
                    <div class="navbar-nav ml-auto col-md-12 justify-content-end">
                        <a href="/queFem" id="nav-button" class="nav-item nav-link"><?php echo app('translator')->get('layout.what-we-do'); ?></a>
                        <a href="/quiSom" id="nav-button" class="nav-item nav-link"><?php echo app('translator')->get('layout.who-we-are'); ?></a>
                        <a href="/resource" id="nav-button" class="nav-item nav-link">RECURSOS</a>
                        <a href="/post" id="nav-button" class="nav-item nav-link">BLOG</a>
                        <a href="/contact" id="nav-button" class="nav-item nav-link"><?php echo app('translator')->get('layout.contact'); ?></a>
                    </div>
        </div>
    </nav>
<main class=" py-4">

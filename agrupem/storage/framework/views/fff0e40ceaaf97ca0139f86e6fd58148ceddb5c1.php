        ...
        <div class="collapse navbar-collapse flex-wrap" id="navbarTogglerDemo01">
            ...
            <div class="navbar-nav ml-auto align-content-centre col-md-12 justify-content-end">
                ...
                <?php $locale = session()->get('locale'); ?>
                    ...
                    <div class="">
                        <a class="nav-link nav-item " href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="navbar-nav ml-auto col-md-12 justify-content-end">
                        <a href="/queFem" class="nav-item nav-link"><?php echo app('translator')->get('layout.what-we-do'); ?></a>
                        <a href="/quiSom" class="nav-item nav-link"><?php echo app('translator')->get('layout.who-we-are'); ?></a>
                        <a href="/resource" class="nav-item nav-link">RECURSOS</a>
                        <a href="/post" class="nav-item nav-link">BLOG</a>
                        <a href="/contact" class="nav-item nav-link"><?php echo app('translator')->get('layout.contact'); ?></a>
                    </div>
        </div>
    </nav>
<main class=" py-4">
